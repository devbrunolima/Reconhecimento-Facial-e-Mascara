...
def DispID(x, y, w, h, NAME, Image):
 ...
 #  ------------------------------------    THE DRAWING OF THE BOX AND ID   --------------------------------------
    ...
    cv2.rectangle(Image, (int(Name_X_pos-10), int(Name_y_pos-30)),(int(Name_X_pos +20 + (len(NAME) * 25)), int(Name_y_pos-1)), WHITE, 1)#(0,0,0), -2)
    cv2.rectangle(Image, (int(Name_X_pos-10), int(Name_y_pos-30)),(int(Name_X_pos +20 + (len(NAME) * 25)), int(Name_y_pos-1)), WHITE, 1)           # Draw a Black Rectangle over the face frame
    cv2.putText(Image, NAME, (int(Name_X_pos), int(Name_y_pos - 10)), cv2.FONT_HERSHEY_DUPLEX, .99, WHITE)                         # Print the name of the ID
...
#  --------------------------------- THE POSITION OF THE ID BOX  -------------------------------------------------        
 ...
 #  ------------------------------------    THE DRAWING OF THE BOX AND ID   --------------------------------------
    cv2.rectangle(Image, (int(Name_X_pos-10), int(Name_y_pos-25)),(int(Name_X_pos +10 + (len(NAME) * 7)), int(Name_y_pos-1)), WHITE, 1)#(0,0,0), -2)
